...
float3 UTS_MainLight(LightLoopContext lightLoopContext, FragInputs input, DirectionalLightData lightData, out float inverseClipping, out float channelOutAlpha, out UTSData utsData)
{
