...
| Set HighColor Mask and Tweak the level of the mask 	| 2.0 	| 2.0.7 	| 2.2.0 	| Internal test 	|  	|
| ***5. RimLight features*** 	|  	|  	|  	|  	|  	|
...
| Offset the outline along with the Z-axis of the camera coordinate 	| 2.0 	| 2.0.7 	| 2.2.0 	| Internal test 	|  	|
