...
class Program
{
    static void Main()
    {
        try
        {
            ...
            string commonPropertiesPath = "com.unity.toonshader/Runtime/Integrated/Shaders/CommonProperties.shader";
            ...
            {
                Console.WriteLine("ERROR: Failed to extract properties from CommonProperties.shader");
                return;
            }
            ...
            string tessellationPropertiesPath = "com.unity.toonshader/Runtime/Integrated/Shaders/TessellationProperties.shader";
            ...
            {
                Console.WriteLine("ERROR: Failed to extract properties from TessellationProperties.shader");
                return;
            }
